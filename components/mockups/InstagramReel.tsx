...
export default function InstagramReel({ image, username, profileImage }: Props) {
  return (
    <div className="w-[375px] h-[812px] bg-black rounded-xl overflow-hidden shadow-xl relative">
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex items-end px-3 pb-4">
          ...
          <div className="flex-1 space-y-3 pr-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white text-[13px] font-semibold">{username || 'username'}</span>
              <button className="border border-white text-white text-xs px-3 py-1 rounded-lg font-medium">
                Folgen
              </button>
            </div>
            <p className="text-white text-[13px] leading-tight">
              Das ist ein Beispiel-Reel ✨🎬
            </p>
            <div className="flex items-center gap-2">
              ...
              <span className="text-white text-[11px]">{username || 'username'} · Originalsound</span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-5">
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <span className="text-white text-[11px] font-medium">45,2K</span>
            </div>
            {/* Comment */}
            <div className="flex flex-col items-center gap-1">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8">
              ...
              <span className="text-white text-[11px] font-medium">1.284</span>
            </div>
            {/* Share */}
            <div className="flex flex-col items-center gap-1">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8">
              ...
              <span className="text-white text-[11px] font-medium">2.1K</span>
            </div>
            {/* More */}
        ...
        {/* Bottom Nav */}
        <div className="flex justify-around items-center py-2 border-t border-white/10">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="white"><path d="M4 3h16a1 1 0 011 1v2H3V4a1 1 0 011-1zM3 8h18v3H3V8zm0 5h18v3H3v-3zm0 5h18v2a1 1 0 01-1 1H4a1 1 0 01-1-1v-2z"/></svg>
